...
void OLED::SendChar(unsigned char data) 
{
  ...
  WireOLED.beginTransmission(_address); // begin transmitting
  WireOLED.write(0x40);//data mode
  WireOLED.write(data);
  WireOLED.endTransmission();    // stop transmitting
}
...
void OLED::sendCharXY(unsigned char data, int X, int Y)
{
  ...
  for(int i=0;i<8;i++)          
    WireOLED.write(pgm_read_byte(myFont[data-0x20]+i));
...
{
  WireOLED.beginTransmission(_address);     //begin transmitting
  WireOLED.write(0x80);                          //command mode
  WireOLED.write(com);
  WireOLED.endTransmission();                    // stop transmitting
}
